...
base_directory = "nietzsche_lang_model"


def save_model(model,
               text_window, slide, len_chars, char_indices, indices_char):
    model_path = os.path.join(base_directory, "nietzsche_model.json")
...
if __name__ == "__main__":
    ...
    if len(sys.argv) == 1:
        print("start the training passing the number of epochs \n"
              "python Nietzsche.py 200")
        exit(1)
